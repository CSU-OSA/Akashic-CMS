...
export interface ApiResourceResource extends Schema.CollectionType {
  ...
  attributes: {
    ...
    uploadDate: Attribute.DateTime;
    readable_users: Attribute.Relation<
    ...
    owners: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    status: Attribute.Enumeration<['censoring', 'published', 'blocked']> &
      Attribute.Required &
      Attribute.Private &
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    own_resources: Attribute.Relation<
      ...
      'api::resource.resource'
    >;
    readable_resources: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::resource.resource'
    >;
